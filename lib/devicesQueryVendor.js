...
module.exports = function (data,callBack) {
    ...
    format: 'devicesQueryVendor Progress |' + _colors.cyan('{bar}') + '| {percentage}% || {value}/{total} Chunks || Speed: {speed}',
    barCompleteChar: '\u2588',
    barIncompleteChar: '\u2591',
    hideCursor: true
});
    return new Promise(async (resolve,reject) => {
        ...
        const vendors = ["American Power Conversion Corp.", "Cisco", "Citrix NetScaler", "Meraki Networks, Inc.", "Neoteris, Inc.", "net-snmp", "OpenGear", "Palo Alto Networks", "Riverbed Technology", "Unknown"];
